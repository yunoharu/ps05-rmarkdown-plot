...
3.  It looks alright. However, I found the variable names a little bit
    long and confusing. I also could not see all the variables because
    it has 25 variables.
...
(a) Iso-2 code "NA" was connected to more than one name. It was
    connected to another "name" and the country "Namibia". Probably, the
    first NA indicates the missing values and the second NA indicates
    the country code of Namibia.
...
(b) Name "NA" was connected to more than one iso3-code. The countries
    that were connected to NA were CHANISL, GBM, KOS, and NLD CURACAO.
...
3.  In the first figure (Co2), the United States have kept emitting more
    CO2 than most of the other countries, and China's emission of CO2
    has recently skyrocketted and surpassed that of US. In the second
    figure (CO2 per capita), although the amount of CO2 emissions of
    China has recently increased, the US has been emitted most CO2 over
    the time. India's emission has also increased recently, but in terms
    of CO2 per capita, the amount is pretty small. Japan and France have
    kept emitting a fair amount of CO2. Therefore, United States has
    emitted more CO2 than any other countries in terms of CO2 per
    capita, and although the Co2 emission of China and India has
    increased, their emission is less than those of the US when it comes
    to CO2 per capita because their population is very large. It is
    important to analyze using both absolute emission amount and
    emission per capita.
...
4.  Europe has a stable and high per capita CO2 emissions, and Asia has
    also maintained a high level after a sharp increase in the 1960s. In
    the Americas, emissions have varied widely from year to year, but in
    recent years emissions have declined compared to the 1970s and
    1980s. Emissions in Oceania are lower than in other regions, and
    even lower in Africa. Africa's low per capita CO2 emissions can be
    attributed to its slow industrialization and large population.
...
6.  Since there was no available value for 2019, I used 2016 data
    instead.
...
2. Since there was no available value for 2019, I used 2016 data
    instead.
```{r, warning=FALSE}
gapminder %>% 
...
-----
I think I spent 6-7 hours on this PS.
